...
const calculate = () => {
  ...
  client.channels.cache.get(CHANNEL_ID).send(`The year is **${percentage}%** complete. (**${elapsedDays}** days elapsed, **${remainingDays}** days remaining)`);
};
